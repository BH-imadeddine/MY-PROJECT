    ...
    <head>
           ...
           var rechrche = $("#rechrche").val();
              $.ajax({
                  ...
                  type:"post",
                  url: "search/search_visite_technique.php",
          ...
          <div id="confirm">
                     ...
                     <div class="colonedroit">
                         <aside id="stylebody">
                              <fieldset id="filbordr" >
                                    <legend><h2 id="legh5"><i class="fa fa-wrench"></i> Liste visite technique</h2></legend> 
			...
			<div style="width:90%; overflow-x: hidden; max-height: 450px;">			
                         <table class="ui teal table" id="tablewidh">
                             ...
                             <tbody id="UserListe">
                                <?php include './liste_body/body_visite_technique/body_visite_technique.php'; ?> 
                             </tbody>
                                       ...
                                       <div class="modal-content">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">L'Ajout du  Visite Technique</h4>
                                         </div>
                              
                                     <div class="modal-body">
                                        
                                         <form action="../Post/Add/add_visitetechnique.php" method="post">
                                             <table class="table table-striped">
              <tr>
                  <td> <label>Date debut</label> <input class="form-control" type="date" name="dateD"> </td>
                    <td>  <label>Date fin</label> <input class="form-control" type="date" name="dateF"></td> 
