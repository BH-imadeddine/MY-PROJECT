                     ...
                     <div class="colonedroit">
                         <aside id="stylebody">
                              <fieldset id="filbordr" >
                                    <legend><h2 id="legh5">Liste parc</h2></legend> 
                        <div class="tab_btn" >
                         ...
                         <table class="ui teal table" id="tablewidh">
                             ...
                             <tbody id="UserListe">
                                   <?php include './liste_body/body_parc/body_parc.php'; ?>
                                   </tbody>
                                       ...
                                       <div class="modal-content">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">l'Ajout  du  parc</h4>
                                         </div>
                              
                                     <div class="modal-body">
                                         <form action="../Post/Add/add_parc.php" method="post">
                                             <div></div>
                                             <table class="ui basic table">
               <tr>
                  <td><label>Nom du parc</label><input class="form-control" type="text" name="nom_parc" size="20"></td>
                 
                  
              
                  <td>
                      <label>Lieu du parc</label> <input class="form-control" type="text" name="lieu_parc" size="20">
                  </td>
               </tr>
			  <tr>
                   <td>
                     <label>Matricule du gerant</label><select name="matG" class="form-control" >
                           <?php $res1=$db->query("SELECT mat_gerant FROM gerant mat_gerant ");
                           while($row1=$res1->fetch()){?>
                           <option><?php echo $row1['mat_gerant'];?></option>
                           <?php } ?>
                       </select>                  </td>
                
                  <td>
                      <label>Capacité du parc </label> <input class="form-control" type="number" name="capacite_parc"> 
                  </td>
              </tr>
          </table> 
