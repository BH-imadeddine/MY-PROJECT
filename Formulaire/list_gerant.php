                     ...
                     <div class="colonedroit">
                         <aside id="stylebody">
                             <fieldset id="filbordr" >
                                    <legend><h2 id="legh5">Liste gerant</h2></legend> 
                        <div class="tab_btn" >
                       ...
                       <div style="width:90%; overflow-x: hidden; max-height: 450px;">         
                         <table class="ui teal table" id="tablewidh">
                             ...
                             <tbody id="UserListe">
                                <?php  include './liste_body/body_gerant/body_gerant.php'; ?>
                             </tbody>
                                       ...
                                       <div class="modal-content">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">L'ajout du  gerant</h4>
                                         </div>
                              
                                     <div class="modal-body">
                                        
                                         <form action="../Post/Add/add_gerant.php" method="post">
                                             <table class="table table-striped">
              <tr>
                  <td><label>Matricule gerant</label><input class="form-control" type="text" name="mat_gerant"></td>
                  <td><label>Nom</label><input class="form-control" type="text" name="nom"></td>
                  </tr>
              <tr><td><label>Prenom</label><input class="form-control" type="text" name="prenom"></td>
              
                  <td>
                      <label>Login</label> <input class="form-control" type="text" name="logGerant">
                  </td>
                  
              </tr>
              <tr><td>
                      <label>mot de pass</label> <input class="form-control" type="text" name="mdpG"> 
                  </td>
                  <td>
                      <label>Email</label> <input class="form-control" type="text" name="emai"> 
                  </td>
                  </tr>  
          </table> 
