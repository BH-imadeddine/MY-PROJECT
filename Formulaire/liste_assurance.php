...
<html>
    <head>
           ...
           var rechrche = $("#rechrche").val();
              $.ajax({
                  ...
                  type:"post",
                  url: "search/search_assurance.php",
    ...
    <body>
            ...
            <div class="contre">
                     ...
                     <div class="colonedroit">
                         <aside id="stylebody">
                              <fieldset id="filbordr" >
                                    <legend><h2 id="legh5"><i class="fa fa-certificate"></i> Liste assurance</h2></legend> 
                           <div class="tab_btn" >
                         ...
                         <table class="ui teal table" id="tablewidh">
                             ...
                             <tbody id="UserListe">
                                  <?php include './liste_body/body_assurance/body_assurance.php'; ?>
                                            </tbody>
                                       ...
                                       <div class="modal-content">
                                        <div class="modal-header">
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">L'Ajout d' Assurances</h4>
                                         </div>
                              
                                     <div class="modal-body">
                                        
                                         <form action="../Post/Add/add_assurance.php" method="post">
              ...
              <tr>
                  <td>
                      <label>Mattriculation_vehiculet</label> <select name="matVehi"  class="form-control" required>
                          <?php $res1=$db->query("SELECT mattriculation_vehi FROM vehicule");
                          while($row1=$res1->fetch()){?><option><?php echo $row1['mattriculation_vehi'];?></option>
                          <?php }?>
                      </select>
                  </td>
                  <td>
                     <label>Agence</label> <input type="text" name="agence" class="form-control" required>
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td rowspan="2">
                      <label>Montant</label> <input type="text" class="form-control" name="montantMis" required>
                  </td>
                  <td></td>
              </tr>
